 ...
 * a new image which is either the horizontally flipped version of the source
 * image ("fh"),
 * or the vertically flipped version of the source image ("fv"), or the
 * grayscaled version of the
...
public class Editor1 {
	...
	public static void main(String[] args) {
		...
		// Reads the input image and creates an empty output imag
